/*
 Author: Amith
 Description: This is a casperjs automated test script for showning that, whether notebook folder name is visible or not
 */

//Begin Tests

casper.test.begin(" Notebook folder name visible ",6, function suite(test) {
    ...
    casper.wait(4000).then(function(){
       this.test.assertTextExists('PREFIX', 'page body contains "foldername"'); 
    ...
    casper.then(function (){
        var z = casper.evaluate(function triggerKeyDownEvent() {
            jQuery("#notebook-title").text("Notebook12");
            var e = jQuery.Event("keydown");
            e.which = 13;
            e.keyCode = 13;
            jQuery("#notebook-title").trigger(e);
