...
//Begin Tests
casper.test.begin("Customizing the thumbnail image of the notebook", 10, function suite(test) {
    ...
    var fileName = 'SampleFiles/plot.png'; // File path directory
    ...
    casper.wait(10000).then(function () {
        ...
        this.test.assertSelectorHasText(x(".//*[@id='asset-list']/li[3]/a/span[1]"), 'plot.png', 'Uploaded file is present in assets');
    });
    
    casper.wait(4000);
    
    // Renaming uploaded png
    casper.viewport(1024, 768).then(function () {
		this.wait(3000);
       // title = functions.notebookname(casper);
        //this.echo("Present title of notebook: " + title);
        var z = casper.evaluate(function triggerKeyDownEvent() {
            jQuery("#asset-list > li:nth-child(3) > a:nth-child(1) > span:nth-child(1)").text("thumb.png");
            var e = jQuery.Event("keydown");
            e.which = 13;
            e.keyCode = 13;
            jQuery("#asset-list > li:nth-child(3) > a:nth-child(1) > span:nth-child(1)").trigger(e);
            return true;
        });
    ...
    casper.wait(6000).then(function () {
        this.test.assertSelectorHasText(x(".//*[@id='asset-list']/li[3]/a/span[1]"), 'thumb.png', 'Uploaded file is present in assets and renamed');
    });
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        this.echo("Present title of notebook: " + title);
        var z = casper.evaluate(function triggerKeyDownEvent() {
            jQuery("#notebook-title").text("thumbnail12");
            var e = jQuery.Event("keydown");
            e.which = 13;
            e.keyCode = 13;
    ...
    casper.wait(4000).then(function(){
       this.test.assertTextExists('thumbnail12', 'page body contains notebook'); 
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        this.echo("Present title of notebook: " + title);
        var z = casper.evaluate(function triggerKeyDownEvent() {
            jQuery("#notebook-title").text("png12");
            var e = jQuery.Event("keydown");
            e.which = 13;
            e.keyCode = 13;
            jQuery("#notebook-title").trigger(e);
