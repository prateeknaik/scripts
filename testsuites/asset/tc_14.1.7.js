...
casper.test.begin("Deleting an Assets div", 5, function suite(test) {
    ...
    casper.then(function () {
        ...
        this.click(".active > a:nth-child(1) > span:nth-child(2) > i:nth-child(1)");
        console.log('clicking on delete icon');
        this.test.assertSelectorDoesntHaveText("#asset-list",'PHONE.csv', "Newly created asset gets deleted");
    });
