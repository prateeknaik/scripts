/* 
 ...
 notebook which is unstarred and currently loaded in the main page, it gets deleted from  the 'All Notebooks' list and the
 previously loaded notebook gets loaded
*/

//Begin Tests

casper.test.begin("Delete notebook which is loaded and unstarred", 4, function suite(test) {
    ...
    // Getting the title of new Notebook and unstar the notebook
