casper.test.begin("Disable multiple extension from setting div", 5, function suite(test) {
    ...
    casper.then(function () {
        test.assertNotVisible(".icon-sun", "Workspace div is disabled");
        test.assertNotVisible(".icon-table", "Dataframe div is disabled");
    });
