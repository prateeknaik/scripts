/*
 Author: Prateek
 Description:To run a code written in the Shell cell, use either the 'run' icon or 'result' icon present on the
 side of the respective Shell cell or 'ctrl+enter' from keyboard. For the first time, user has to use 'ctrl+enter'
 */

//Begin Test
casper.test.begin("Creating a Shell cell and Run the notebook", 4, function suite(test) {
