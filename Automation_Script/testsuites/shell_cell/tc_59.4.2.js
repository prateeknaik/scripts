/*
 Author: Prateek
 Description:The 'Hide output' option will remain inactive if the cell is not executed yet. 
 Clicking on 'Hide output' will do nothing till the cell is executed
 */

//Begin Test
casper.test.begin("Show/Hide output for un executed cell", 6, function suite(test) {
