...
casper.test.begin("view.html for markdown cell with Rcode", 6, function suite(test) {
    ...
    casper.then(function(){
		this.test.assertDoesntExist({type:'xpath', path:".//*[@id='part1.R']/div[3]/div[2]"},'Since by default show source option is not selected hence source code is not visible');
        ...
        this.test.assertDoesntExist({type:'xpath', path:".//*[@id='part1.R']/div[3]/div[2]"},"Even after clicking on 'Show source' option, source code is not visible");
    });
