/*
 Author: Prateek
 Description:This test describes,check whether the 2nd admin is able to view the Notebook or not
 */
//Begin Tests
casper.test.begin("Assigning single notebook to a group with multiple admin to that group ", 8, function suite(test) {
    ...
    casper.then(function () {
        ...
        this.sendKeys(x(".//*[@id='group-tab']/div[2]/div/div/div[1]"), 'tejas1493');
        this.wait(3000);
        this.click(x(".//*[@id='group-tab']/div[2]/div/div/div[2]/div/div"), 'tejas1493', {keepFocus: true});
    ...
    casper.wait(2000).then(function () {
        ...
        this.wait(1000);
        this.echo('Inserted both the admin to the group');
    });
