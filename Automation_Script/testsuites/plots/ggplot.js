casper.test.begin("Test script for ggplot", 8, function suite(test) {
    ...
    var URL;
    var NB_ID = 'eea609a6512eda962f6e';
    ...
    casper.then(function(){
        ...
        this.waitForSelector('.live-plot-container', function () {
            this.test.assertExists('.live-plot-container', 'Confirmed that cell has prodeced expected plot using "ggplot" library');
        });
    });
