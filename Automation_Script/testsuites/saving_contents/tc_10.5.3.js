/*
 ...
 Author: Arko
 Description:This is a casperjs automation script for showing that The loaded notebook will contain RMarkdown cell which has been executed. Now,
 edit the content of that cell. The 'save' icon present in the navbar on the top-left corner of the page will be enabled. Click on the
 icon and check whether the changes are saved or not
 */
casper.test.begin(" Using save icon present in the navbar - Edit Markdown cell (Pre-executed)", 7, function suite(test) {
