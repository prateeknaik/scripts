 ...
 */
casper.test.begin(" Edit Markdown cell (Pre-executed)", 7, function suite(test) {
    ...
    casper.then(function(){
        ...
        this.echo('before modifying cell content is:' +before);
    });
    ...
    casper.then(function(){
        ...
        this.echo('after modifying cell content is:' +after);
    });
