 ...
 * sorted wrt to the 'User' that is with respect to Username  in descending order
*/

//Begin Tests

casper.test.begin("Sorting the searched results according to 'User' in 'descending' order", 4, function suite(test) {
