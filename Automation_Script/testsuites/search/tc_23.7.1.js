/* 
 ...
 when searched without double quotes
...
casper.test.begin(" Text searched is highligted in the text area when searched in double quotes", 6, function suite(test) {
	...
	//verify that the searched item is found in the local user's div
            ...
            for (var i = 1; i <= counter; i++) {
                ...
                //this.echo(result);
                if (result == combo) {
                    this.test.assertExists(x('/html/body/div[2]/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/table[' + i + ']/tbody/tr[2]/td/div/table/tbody/tr[2]/td/table/tbody/tr/td[2]/code/b'), 'Search item is highlighted');
                    var temp = this.fetchText(x('/html/body/div[2]/div/div/div[2]/div/div/div[2]/div[2]/div/div/div[2]/div/div/table[' + i + ']/tbody/tr[2]/td/div/table/tbody/tr[2]/td/table/tbody/tr/td[2]/code'));
    ...
    casper.then(function(){
		var temp5 = this.getElementInfo({type:'xpath' ,path:".//*[@id='0']/table/tbody/tr[2]/td/table/tbody/tr/td/code/b"}).tag;
