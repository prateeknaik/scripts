 ...
 * that is with respect to the number of stars, the notebook having in ascending order
 */

//Begin Tests

casper.test.begin("Sorting the searched results according to 'Star' in 'ascnding' order", 4, function suite(test) {
