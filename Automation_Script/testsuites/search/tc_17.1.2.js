...
'full-text search' will consist of Uppercase Letters like RNORM, PRINT etc. only
*/

//Begin Tests
casper.test.begin(" Uppercase Letters -Ex: RNORM, FUNCTION, PRINT", 6, function suite(test) {
    ...
    var item = '"FUNCTIONTOBESEARCHEDHERE"';//item to be searched
    ...
    casper.then(function(){
		if (this.visible('#input-text-search')) {
            ...
            if (counter >0)
            {
				this.test.pass("search feature is working for upper case keywords");
			}
			else
				{
