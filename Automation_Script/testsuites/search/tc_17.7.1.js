/* 
 ...
 'full-text search' will consist of Alphabets, Numbers and Special Characters like rnorm(111), print("hello 123") etc. only
...
casper.test.begin(" Alphabets, Numbers and Special Characters (Ex: rnorm(121) ) )", 5, function suite(test) {
    ...
    var item = '"rnorm(121)"';//item to be searched
    ...
    casper.then(function(){
		if (this.visible('#input-text-search')) {
            ...
            if (counter >0)
            {
				this.test.pass("search feature is working for alphabets, numbers and special characters");
			}
			else
				{
					this.test.fail("search feature is not working for alphabet, numbers and special characters");
				}
		});
