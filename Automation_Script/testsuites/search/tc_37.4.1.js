 ...
 * sorted wrt to the 'date' that is with respect to Username  in ascending order
*/

//Begin Tests

casper.test.begin("Sorting the searched results according to 'Date' in 'ascnding' order", 4, function suite(test) {
