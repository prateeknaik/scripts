 ...
 * sorted wrt to the 'name' that is with respect to Username  in ascending order
 */

//Begin Tests

casper.test.begin("Sorting the searched results according to 'Name' in 'ascnding' order", 4, function suite(test) {
    ...
    casper.then(function () {
        ...
        name1 = name.sort();
        this.test.assertEquals(name, name1, "Searched results are sorted according to 'Name' in 'ascending' order");
    });
