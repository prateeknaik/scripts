...
//Begin Tests
    ...
    casper.then(function(){
        ...
        casper.viewport(1024, 768).then(function () {
            ...
            this.test.assertDoesntExist({type: 'xpath', path: '/html/body/div[3]/div/div/div/div[1]/div/div[2]/div[1]/div[1]/pre/code'}, 'When view.html page opens, source code doesnot exists. Hence "Show source" check box is not selected by default');
            this.wait(5000);
        });
