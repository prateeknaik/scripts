...
casper.test.begin("If a notebook is added in the list of 'All Notebooks' and its respective star is selected and count=1, then unstarring that notebook should remove it from the 'Notebooks I Starred' list and unstar it in 'People I Starred' list", 6, function suite(test) {
