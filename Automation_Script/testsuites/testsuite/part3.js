...
console.log('This is an automated testscript to be check all the  basic features are working properly');
console.log('The features to be tested are : Login to RCloud, creating a new notebook, Executing cell contents(R, Python, Markdown and Shell), adding & deleting comments ');
console.log("Workspace Div, Dataframe Div, Notebook encryption, File Upload, opening Notebook in GitHub");
console.log("and Verifying for all the sharable links ");

casper.test.begin("Automation testing part-3", 30, function suite(test) {
    ...
    casper.then(function () {
        ...
        //Verifying for the fork options
        casper.then(function () {
            console.log("---------- Forking Loaded notebook -----------");
            functions.fork(casper);
        });


        //Fork Notebook, Click on RunAll and verify the output
        casper.then(function () {
        ...
        casper.then(function () {
            ...
            casper.then(function () {
                this.test.assertDoesntExist(x(".//*[@id='comments-container']/div/div[2]/div/div"), comment, 'Confirmed that entered commment is deleted');
            });
        });

        //Verifying for workspace div
        casper.then(function () {
            console.log("---------- Verifying for workSpace div -----------");
        ...
        casper.then(function () {
            ...
            this.then(function () {
                this.echo("Deleting Uploaded File to th Notebook");
        ...
        casper.then(function () {
            ...
            this.then(function () {
                ...
                this.wait(3000);
                this.test.assertEquals(status, 'privateprivate', "The notebook has been converted to private successfully")
            });
        });
        ...
        casper.then(function () {
            this.wait(5000, function () {
                //this.click(x(".//*[@id='upload-to-notebook']"));#upload-to-notebook
                //console.log("Clicking on Upload to notebook check box");
                this.click(x(".//*[@id='upload-submit']"));
                console.log("Clicking on Submit icon");
            });
        ...
        casper.then(function () {
            console.log("---------- Open Notebook in Github -----------")
