/*
 Author: Sanket (tc_61.2.2.js)
 Description: This is casperJS automated test to check whether locator() gets invoked with R cell without plot in view.html
*/
//Begin

casper.test.begin("Invoke locator function without plot in view.html", 6, function suite(test) {
