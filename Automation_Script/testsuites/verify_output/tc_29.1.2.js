/* 
 Author: Prateek
 Description:    This is a casperjs automated test script for showing that, Executing valid R code produces expected or not
 */

//Begin Tests

casper.test.begin("Clicking Split Cell option for the first cell ", 6, function suite(test) {
