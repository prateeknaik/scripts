/* 
 Author: Sanket 58.4.8
 Description: This Test scripts automate the feature which converts private notebook to public
*/
//Begin Tests

casper.test.begin("Making notebook public from private", 4, function suite(test) {
    ...
    casper.then(function(){
        this.wait(2000)
        functions.comments(casper,"comment 1")
    });
    //Makin private notebook back to public
    casper.then(function(){
        this.mouse.move('.jqtree-selected > div:nth-child(1)');
        this.wait(2000)
        this.click(".jqtree-selected > div:nth-child(1) > span:nth-child(2) > span:nth-child(3) > span:nth-child(1) > span:nth-child(1) > i:nth-child(1)")
        ...
        this.then(function(){
            ...
            this.setFilter("page.prompt", function (msg, currentValue) {
                this.echo(msg)
                if (msg === "Are you sure you want to make notebook "+notebook_name+" public? This will make it accessible by everyone.") {
                return TRUE;
            }
        });
        this.click('span.btn:nth-child(3)');
        this.echo('notebook is made public successfully')
        });
    });

    //Validating private to public conversion
    ...
    casper.then(function(){
        ...
        this.then(function(){
            ...
            this.echo("notebook is "+   status)  
            this.wait(3000)
            this.test.assertEquals(status,'public',"The notebook has been converted to private successfully")
        });        
    }); 
