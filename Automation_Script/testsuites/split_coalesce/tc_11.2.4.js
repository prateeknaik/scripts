...
casper.test.begin("Coalesce combination of two R cells", 6, function suite(test) {
	...
	casper.then(function(){
    	...
    	this.echo("Creating one more cell as R cell")
	});
	...
	casper.viewport(1024, 768).then(function(){	
		this.wait(3000);
		casper.test.assertDoesntExist({ type :  'xpath' , path : '/html/body/div[3]/div/div[2]/div/div[1]/div[2]/div[2]/div[1]/span[4]'}, "Split option doesn't exists");
	});
