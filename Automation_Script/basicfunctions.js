...
exports.addnewcell = function (casper) {
    return casper
        .then(function () {
            this.test.assertTruthy(this.click({type: 'xpath', path: '/html/body/div[3]/div/div[2]/div/div[3]/div[1]/div/span/i'}), 'created new cell');
...
exports.addcontentstocell = function (casper,input_code) {
    return casper
        .then(function () {
			if (this.visible({type: 'xpath', path: '/html/body/div[3]/div/div[2]/div/div[1]/div/div[3]/div[1]/div[2]/div/div[2]/div'})){
...
exports.delete_notebooksIstarred = function (casper) {
    return casper
        .then(function () {
            ...
            this.click({type: 'css', path: 'ul.jqtree_common:nth-child(1) > li:nth-child(1) > ul:nth-child(2) > li:nth-child(1) > ul:nth-child(2) > li:nth-child(' + i + ') > div:nth-child(1) > span:nth-child(2) > span:nth-child(3) > span:nth-child(1) > span:nth-child(5) > i:nth-child(1)'});
